...
const I18N = {
  zh: {
    ...
    howto: {
      ...
      updateHint: "再跑一次安装器。安装器会先停止当前安装中的 Galdr 并清理旧核心文件；完成后 source ~/.galdr/env 再看版本。",
  ...
  en: {
    ...
    howto: {
      ...
      updateHint: "Run the installer again. It stops Galdr from the current installation and removes old core files first; afterwards source ~/.galdr/env and check the version.",
