...
const I18N = {
  zh: {
    ...
    cards: {
      ...
      seeT: "标签与分屏",
      see: "拖开分屏、放大一栏、搜索、命令面板。窗口只是附着，标签和分栏留在会话里。",
      completeT: "按频率补全",
      complete: "Tab 在提示符上方弹出菜单，常用命令排在前面。回车或 Tab 选中后菜单关掉。",
      modelT: "会话恢复",
  ...
  en: {
    ...
    cards: {
      ...
      see: "Drag a split, zoom a pane, search, command palette. The window attaches; tabs and panes stay in the session.",
      completeT: "Frequency completion",
      complete: "Tab opens a menu above the prompt, most-used commands first. Enter or Tab accepts and the menu closes.",
