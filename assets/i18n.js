...
const I18N = {
  zh: {
    ...
    sec: {
      ...
      installLead: "自动识别 Linux / Windows 与 x64 / ARM64，下载后校验 SHA256，再原子替换当前版本。",
      howto: "安装",
      why: "把终端该做的事，做完整。",
      whyKicker: "从像素到进程",
  ...
  en: {
    ...
    sec: {
      ...
      installLead: "Detects Linux / Windows and x64 / ARM64, verifies SHA256, then atomically replaces the current build.",
      howto: "Install",
